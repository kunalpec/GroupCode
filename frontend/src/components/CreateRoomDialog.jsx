...
function CreateRoomDialog({ open, onOpenChange, onSubmit, loading, inviteLink }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[min(94vw,56rem)] rounded-none border border-[#454545] bg-[#252526] p-0 shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
        ...
        <div className="scrollbar-hidden max-h-[calc(90vh-3rem)] overflow-y-auto p-5 pr-4">
          <DialogHeader className="mb-5 space-y-2 pr-14">
          ...
          <div className="mb-5 grid gap-3 border border-[#333333] bg-[#1e1e1e] p-4">
            <p className="text-[11px] uppercase tracking-[0.18em] text-[#3794ff]">Backend to Frontend Flow</p>
            <div className="grid gap-3 lg:grid-cols-3">
              <div className="border border-[#333333] bg-[#252526] p-3">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <label className="block space-y-2">
              ...
              <Input
                className="h-12 border-[#3c3c3c] bg-[#1f1f1f] text-[#cccccc] placeholder:text-[#6a6a6a] focus:border-[#007acc] focus:ring-[#007acc]/20"
                value={roomName}
            ...
            <Button
              className="h-11 w-full border-[#0e639c] bg-[#0e639c] text-[15px] font-semibold text-white hover:border-[#1177bb] hover:bg-[#1177bb]"
          ...
          {inviteLink ? (
            <div className="mt-5 border border-[#333333] bg-[#1e1e1e] p-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button className="gap-2 rounded-none" onClick={handleCopyInvite} type="button" variant="secondary">
                  {copied ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                  {copied ? "Copied" : "Copy"}
                </Button>
              </div>
              <div className="mt-3 border border-[#3c3c3c] bg-[#252526] px-3 py-3">
